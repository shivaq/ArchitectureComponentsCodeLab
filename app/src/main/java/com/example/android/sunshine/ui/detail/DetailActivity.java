...
public class DetailActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    DetailViewModelFactory viewModelFactory = InjectorUtils
        .provideDetailViewModelFactory(this.getApplicationContext(), date);
    detailActivityViewModel = ViewModelProviders.of(this, viewModelFactory)
    ...
    //AppExecutors is a class that contains
    // global thread pools for the main thread, disc I/O and network I/O
//    AppExecutors.getInstance().diskIO().execute(() -> {
//      try {
//        // Pretend this is the network loading data
//        Thread.sleep(4000);
//        Date today = SunshineDateUtils.getNormalizedUtcDateForToday();
//        WeatherEntry pretendWeatherFromDatabase =
//            new WeatherEntry(1, 210, today, 88.0, 99.0, 71,
//                1030, 74, 5);
//        detailActivityViewModel.setWeather(pretendWeatherFromDatabase);
//
//        Thread.sleep(2000);
...
//    });
  ...
  private void bindWeatherToUI(WeatherEntry weatherEntry) {
    ...
    String description = SunshineWeatherUtils
        .getStringForWeatherCondition(DetailActivity.this, weatherId);
    ...
    String windString = SunshineWeatherUtils
