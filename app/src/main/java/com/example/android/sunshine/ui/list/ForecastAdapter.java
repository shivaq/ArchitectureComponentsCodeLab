...
/**
 * Exposes a list of weather forecasts from a list of {@link WeatherEntry} to a {@link
 * RecyclerView}.
 */
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
   ...
   * correct image based on whether the forecast is for today(large image) or the future(small
   * image).
   *
